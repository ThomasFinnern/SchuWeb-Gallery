 ...
 * @subpackage  com_schuweb_gallery
 */
class SchuWeb_GalleryControllerImage extends JControllerForm
{
    /**
    ...
    public function edit($key = null, $urlVar = null)
    {
        ...
        $path = $app->input->get('path', null, null);

        // Check-out succeeded, push the new record id into the session.
        $app->setUserState($context . '.data', null);

        $this->setRedirect(
            JRoute::_('index.php?option=' . $this->option . '&view=' . $this->view_item.'&layout=edit&file='.$file.'&path='.$path, false)
        );
