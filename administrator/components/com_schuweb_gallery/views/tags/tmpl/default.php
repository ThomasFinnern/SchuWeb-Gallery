...
<form action="<?php echo JRoute::_('index.php?option=com_schuweb_gallery&view=tags'); ?>" method="post"
      name="adminForm"
      id="adminForm">
    ...
    <table class="table table-striped" id="articleList">
        ...
        <tr>
            ...
            <th width="31%">
                <?php echo JHtml::_('grid.sort', 'SCHUWEB_GALLERY_TAG_NAME', 'a.name', $listDirn, $listOrder); ?>
            </th>
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id?>">
            ...
            <td class="nowrap has-context">
                <div class="pull-left">
                    <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_schuweb_gallery&task=tag.edit&id=' . (int)$item->id); ?>">
                ...
                <div class="pull-left">
                    ...
                    if ($trashed) :
                        JHtml::_('dropdown.untrash', 'cb' . $i, 'tags.'); else :
