...
<form action="<?php echo JRoute::_('index.php?option=com_schuweb_gallery&view=videos'); ?>" method="post"
      name="adminForm"
      id="adminForm">
    ...
    <table class="table table-striped" id="articleList">
        ...
        <tr>
            ...
            <th width="31%">
                <?php echo JHtml::_('grid.sort', 'SCHUWEB_GALLERY_VIDEO_SERVICE', 'a.video_service', $listDirn, $listOrder); ?>
            </th>
        ...
        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id?>">
            ...
            <td class="nowrap has-context">
                <div class="pull-left">
                    ...
                    <?php endif; ?>
                    <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_schuweb_gallery&task=video.edit&id=' . (int)$item->id); ?>">
                        <?php echo $this->escape($item->video_id); ?></a>
                    <?php else : ?>
                    <?php echo $this->escape($item->video_id); ?>
                    <?php endif; ?>
                    <div class="small">
                ...
                <div class="pull-left">
                    ...
                    JHtml::_('dropdown.edit', $item->id, 'video.');
                    JHtml::_('dropdown.divider');
                    if ($item->state) :
                        JHtml::_('dropdown.unpublish', 'cb' . $i, 'videos.'); else :
                        JHtml::_('dropdown.publish', 'cb' . $i, 'videos.');
                    endif;
            ...
            <td class="small hidden-phone">
                <?php echo JText::_($item->video_service);?>
            </td>
